...
export default class Landing extends Component {
  render() {
    ...
    <div className="scrolling-wrapper">
      ...
      <div className="card"><h2>Great Conversation</h2><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><p>"Awesome conversation, even made a special pit stop for us! Highly recommend!"</p></div>
      <div className="card"><h2>Expert Navigation</h2><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><p>"Good guy fun to chat with"</p></div>
      <div className="card"><h2>Great Conversation</h2><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><p>"Thank you so much!"</p></div>
      <div className="card"><h2>Excellent Service</h2><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><img src={Star} alt='star' id='star'></img><p>"Left our cellphone in his car and he promptly returned to us... awesome"</p></div>
    </div>
    </section>
    </section>
    )
