  ...
  render() {
    return (
      <section className='mapholder'>
        ...
        <p className='key'><img src={RedDot} alt='reddot' id='reddot'></img>Red indicates restaurants.<br /><br />
        <img src={BlueDot} alt='bluedot' id='bluedot'></img>Blue indicates nightlife venues.</p>
      </section>
    )
  }
}